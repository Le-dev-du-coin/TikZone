    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {createdSuccess ? (
        ...
        <form onSubmit={handleCreate} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-xs space-y-5">
          ...
          {/* ARCHITECTURE 100% CLOUD HOTSPOT */}
          <div className="p-4 rounded-2xl bg-emerald-50/70 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800/60 flex items-center gap-3.5 shadow-xs">
            ...
            <div className="text-xs text-slate-700 dark:text-slate-300 space-y-0.5">
              <div className="font-black text-emerald-950 dark:text-emerald-100">
                Architecture 100% Cloud Hotspot Natif
              </div>
              <p className="text-[11px] text-slate-600 dark:text-slate-400">
                Votre MikroTik est configuré automatiquement via un script copié-collé unique. Aucun risque de saturation de mémoire flash, roaming transparent et validation instantanée des tickets.
              </p>
            </div>
          </div>
